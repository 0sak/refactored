...
public class TestPrint {
    ...
    private static Stream<Arguments> sources() {
        return Stream.of(
                Arguments.of("print(123)#end", "123\n"),
                Arguments.of("print(False)#end", "False\n"),
                Arguments.of("print('strVal')#end", "strVal\n"),
                Arguments.of("print(1+1)#end", "2\n"));
                //Arguments.of("print(id(23))#end", "61\n"), IDs differ when running the test on Ubuntu! Hence disabled.
                //Arguments.of("print(id(id(True)))#end", "70\n"),
                //Arguments.of("def testFunc1():print(123)#endid(testFunc1())#end", "123\n103\n"));
    }
    @ParameterizedTest
    @MethodSource("sources")
    void print(String input, String expected, @TempDir Path workDirectory) throws IOException, InterruptedException {
        String result = "";
